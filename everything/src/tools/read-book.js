/**
 * Tool handler for retrieving details of a specific book in Bookstack
 */
export async function handleReadBook(server, args) {
    try {
        // Validate arguments
        ...
        console.log(`Using Bookstack API at ${baseUrl} to retrieve book with ID ${args.id}`);
...
/**
 * Tool definition for read_book
 */
export const readBookToolDefinition = {
    name: 'read_book',
