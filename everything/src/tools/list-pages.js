/**
 * Tool handler for listing pages from Bookstack API
 */
export async function handleListPages(server, args) {
    try {
        // Validate arguments
        ...
        console.log(`Using Bookstack API at ${baseUrl} to list pages`);
        ...
        try {
            ...
            const response = await fetch(`${baseUrl.replace(/\/$/, '')}/api/pages?${params.toString()}`, {
                method: 'GET',
                headers: headers,
...
/**
 * Tool definition for list_pages
 */
