/**
 * Tool handler for listing bookshelves from Bookstack API
 */
export async function handleListBookshelves(server, args) {
    try {
        // Validate arguments
        ...
        console.log(`Using Bookstack API at ${baseUrl} to list bookshelves`);
        ...
        try {
            ...
            const response = await fetch(`${baseUrl.replace(/\/$/, '')}/api/shelves?${params.toString()}`, {
                method: 'GET',
                headers: headers,
...
/**
 * Tool definition for list_bookshelves
 */
export const listBookshelvesToolDefinition = {
