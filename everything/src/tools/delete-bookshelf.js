/**
 * Tool handler for deleting a bookshelf from Bookstack
 */
export async function handleDeleteBookshelf(server, args) {
    try {
        // Validate arguments
        ...
        console.log(`Using Bookstack API at ${baseUrl} to delete bookshelf with ID ${args.id}`);
        ...
        try {
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: true,
                        message: `Bookshelf with ID ${args.id} deleted successfully`
                    }, null, 2),
                }],
            };
        } catch (error) {
...
/**
 * Tool definition for delete_bookshelf
 */
export const deleteBookshelfToolDefinition = {
