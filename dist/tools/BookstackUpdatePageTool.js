...
class BookstackUpdatePageTool extends BookstackTool {
    constructor() {
        super(...arguments);
        this.name = "bookstack_update_page";
        this.description = "Updates an existing Bookstack page";
        this.schema = schema;
    }
    async execute(input) {
        ...
        return this.runRequest(() => this.putRequest(`/api/pages/${input.id}`, payload));
    }
}
