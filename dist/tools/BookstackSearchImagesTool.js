...
const isoDateString = z.string().refine((value) => !Number.isNaN(Date.parse(value)), { message: "Expected an ISO-8601 date string" });
...
class BookstackSearchImagesTool extends BookstackTool {
    constructor() {
        super(...arguments);
        this.name = "bookstack_search_images";
        this.description = "Advanced discovery tool for BookStack image gallery";
        this.schema = schema;
    }
    async execute(input) {
